...
Label4 = ""
Command15.Caption = "正在检查"
Command15.Enabled = 0
WebBrowser1.navigate "http://47.107.121.161/check.html"
Savetime = Timer
While Timer < Savetime + 1
DoEvents
Wend
...
p = "c:\YUYU"
FSO.CreateFolder (p)
MsgBox "欢迎使用YUYU助手！" & vbCrLf & "数据默认存储在" & p & "，可自行更改位置"
End If
Text5 = p
...
L = Mid(Text6, 5)
u = Mid(Text6, 1, 3)
If u > 1.7 And u < 3 Then                   '数值！！！
Command15.BackColor = vbYellow
Command15.Caption = "有新版！"
m = MsgBox("新版本v" & u & "发布啦，是否去升级", vbYesNo, "有新版本可用")
If m = vbYes Then Shell "explorer https://v.xiumi.us/board/v5/3JD5p/228148533"
End If
